...
////////////////////////////////
#define ENABLE_TIME_LOG       true  // DLR: 1 Value
#define ENABLE_CALCULATED_LOG true  // 3 Values
#define ENABLE_ACCEL_LOG      true  // 3 V
#define ENABLE_GYRO_LOG       true  // 3 V
#define ENABLE_MAG_LOG        false // 3 V
#define ENABLE_QUAT_LOG       false // 4 V
#define ENABLE_EULER_LOG      false // 3 V
#define ENABLE_HEADING_LOG    false // 1 V
#define ENABLE_ENV_LOG        true  // 5 V
